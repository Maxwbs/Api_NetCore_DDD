...
using Api.CrossCutting.DependenciasInjetadas;
...
namespace application
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
           ...
           var tokenConfiguration = new TokenConfiguracao();
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Version = "v1",
                    Title = "Curso de Api Com AspeNet Core",
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Curso de Api com Asp Net Core 3.1");
            ...
            if(Environment.GetEnvironmentVariable("MIGRATION").ToLower() == "APLICAR".ToLower())
            {
                ...
                {
                    using (var context = service.ServiceProvider.GetService<Contexto>())
                    {
